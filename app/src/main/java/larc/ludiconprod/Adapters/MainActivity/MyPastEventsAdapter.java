...
public class MyPastEventsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<EventBrief> list = new ArrayList<>();
    //private ArrayList<Sponsors> sponsorsList = new ArrayList<>();
    private Context context;
    private Activity activity;
    private Resources resources;
    private FullHistory fragment;
    final RecyclerView listView;
    public static ProgressBar progressBarCard;

    public MyPastEventsAdapter(ArrayList<EventBrief> list, Context context, Activity activity, Resources resources, FullHistory fragment) {
        this.list = list;
    ...
    public MyPastEventsAdapter(ArrayList<EventBrief> list, Context context, Activity activity, Resources resources) {
        this.list = list;
        this.context = context;
        this.activity = activity;
        this.resources = resources;
    ...
    public void setListOfEvents(ArrayList<EventBrief> newList) {
        this.list = newList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            /*case 0:
                ...
                viewHolder=new MyPastEventsAdapter.ViewHolderSponsors(view);
                break;*/
            case 1:

                view = inflater.inflate(R.layout.full_history, null);
                viewHolder=new MyPastEventsAdapter.ViewHolder(view);
                break;
        ...
        switch (holder.getItemViewType()) {
           /* case 0:
            ...
            case 1:
                ...
                final EventBrief currentEvent = list.get(position);

                ((MyPastEventsAdapter.ViewHolder)holder).view.setOnClickListener(new View.OnClickListener() {
                    @Override
                ...
                ((MyPastEventsAdapter.ViewHolder)holder).profileImage.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                ...
                Sport sport = new Sport(currentEvent.sportName);

                String weWillPlayString = "";
                String sportName = "";

                if (currentEvent.sportName.equalsIgnoreCase("JOG") || currentEvent.sportName.equalsIgnoreCase("GYM") || currentEvent.sportName.equalsIgnoreCase("CYC")) {
                    weWillPlayString = activity.getResources().getString(R.string.has_went_to) + " ";
                    sportName = sport.sportName;
                } else {
                    if (currentEvent.sportName.equalsIgnoreCase("OTH")) {
                        weWillPlayString = activity.getResources().getString(R.string.has_played) + " ";
                ...
                ((ViewHolder)holder).playersNumber.setText(" " + String.valueOf(currentEvent.numberOfParticipants));
                ...
                if (currentEvent.numberOfParticipants - 1 >= 4) {
                    ...
                    ((MyPastEventsAdapter.ViewHolder)holder).friendsNumberLayout.setVisibility(View.VISIBLE);
                ...
                ((ViewHolder)holder).creatorLevelAroundMe.setText(String.valueOf(currentEvent.creatorLevel));
