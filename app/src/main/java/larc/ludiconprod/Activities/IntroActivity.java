...
public class IntroActivity extends Activity {
    ...
    public void goToActivity() {
        if (!go) {
            ...
            HTTPResponseController.getInstance().returnResponse(params, headers, IntroActivity.this, "https://ludicon.info/api/login/");
                    ...
                    new GraphRequest.Callback() {
                        public void onCompleted(GraphResponse response) {
                            ...
                            try {
                                ...
                                HashMap<String, String> headers = new HashMap<String, String>();
                                headers.put("apiKey", "b0a83e90-4ee7-49b7-9200-fdc5af8c2d33");
                                HTTPResponseController.getInstance().returnResponse(params, headers, IntroActivity.this, "https://ludicon.info/api/register/");
                            } catch (Exception e) {
                                e.printStackTrace();
