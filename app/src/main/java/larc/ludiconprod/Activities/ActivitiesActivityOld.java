 ...
 */
/*
public class ActivitiesActivityOld extends Fragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, Response.ErrorListener {
    ...
    static public ActivitiesActivityOld currentFragment;
    ...
    public void getMyEvents(String pageNumber) {
        ActivitiesActivityOld.getFirstPageMyActivity = pageNumber.equals("0");
